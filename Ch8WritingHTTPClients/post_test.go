...
// A handler that can decode JSON into a User object
...
// Encoding a User object to JSON and POST to the test server
...
// Creating a new request body, multipart writer, and write form data
func TestMultipartPost(t *testing.T) {
	...
	// Writing two files to the request body, each in its own MIME part
	...
	// Sending a POST request to httpbin.org with Go's default HTTP client
